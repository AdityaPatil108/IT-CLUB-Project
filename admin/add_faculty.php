...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($email_err)) {
        ...
        $sql = "INSERT INTO users (username, password, email, role) VALUES (?, ?, ?, 'faculty')";
...
<head>
    ...
    <title>Add Faculty - IT Club</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="admin-header d-flex justify-content-between align-items-center">
                    <h1 class="h2">Add New Faculty</h1>
                    <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i> Only faculty members can add new faculty accounts. This ensures proper security control.
                            </div>
