...
<head>
    ...
    <title>Edit Faculty - IT Club</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="admin-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="manage_faculty.php" class="btn btn-outline-light btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Back to Faculty
                        </a>
                    </div>
                </div>
                ...
                <div class="admin-content">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $id, ENT_QUOTES, 'UTF-8'); ?>" method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-grid">
                                        <a href="reset_faculty_password.php?id=<?php echo $id; ?>" class="btn btn-outline-secondary">Reset Password</a>
                                    </div>
                                    <small class="text-muted">Click the button above to reset this faculty's password.</small>
                                </div>
