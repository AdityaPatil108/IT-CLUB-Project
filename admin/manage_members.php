...
// Get all members
$sql = "SELECT * FROM users WHERE role = 'member' ORDER BY username";
...
<head>
    ...
    <title>Manage Members - IT Club</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="admin-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="add_member.php" class="btn btn-outline-light btn-sm">
                                        ...
                                        <tbody>
                                            <?php while($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_member.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        <a href="manage_members.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this member?')">
